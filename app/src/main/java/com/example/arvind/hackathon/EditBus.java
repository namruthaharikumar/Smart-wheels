...
public class EditBus extends AppCompatActivity implements AdapterView.OnItemSelectedListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Spinner areaSpinner = (Spinner) findViewById(R.id.spinner);
                    ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(EditBus.this, android.R.layout.simple_spinner_item, areas);
        ...
        {
            Toast.makeText(EditBus.this, "Check Your Internet Connection",
    ...
    private void entry(){
        ...
        Toast.makeText(EditBus.this, "Saved Successfully",
                Toast.LENGTH_SHORT).show();
